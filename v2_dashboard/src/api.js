...
//
// VITE_API_BASE_URL (2026-08): the deployed dashboard talks to a separately
// deployed v2_serving instance, whose URL isn't known at write-time -- same
// build-time-env-var pattern as v1's NEXT_PUBLIC_API_BASE_URL. Falls back to the
// original hardcoded local dev address when unset, so local `npm run dev` is
// unchanged.
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "http://127.0.0.1:8734";
